...
module.exports = {
    ...
    eventNames: {
        ...
        trayEventDisplayBalloon: "tray.event.display.balloon",
        trayEventGetTitle: "tray.event.get.title",
        trayEventTitleGet: "tray.event.title.get",
        trayEventSetTitle: "tray.event.set.title",
        ...
        windowCmdSetMinHeight: "window.cmd.set.minheight",
        windowCmdSetMinWidth: "window.cmd.set.minwidth",
